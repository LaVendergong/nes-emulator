...
/**
 * Mapper 79（NINA-03/06）。写 $4100–$5FFF：bit3 起 32K PRG，低 3 位 8K CHR。
 */
final class Nina implements Cartridge {
    ...
    Nina(byte[] prg, byte[] chr, boolean chrRam, boolean verticalMirroring) {
        this.prg = prg;
        this.chr = chr;
        this.chrRam = chrRam;
    ...
    public void loadState(java.io.DataInput in) throws java.io.IOException {
        if (in.readInt() != 79) {
            throw new java.io.IOException("存档不是 NINA");
        }
